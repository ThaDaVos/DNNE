...
internal class CodeGenerator : AbstractCodeGenerator
{
    public CodeGenerator(AssemblyInformation assemblyInformation, INamingHelper namingHelper) : base(assemblyInformation, namingHelper)
    {
    }
