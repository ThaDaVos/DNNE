...
internal class IncludeGenerator : AbstractCodeGenerator
{
    public IncludeGenerator(AssemblyInformation assemblyInformation, INamingHelper namingHelper) : base(assemblyInformation, namingHelper)
    {
    }
