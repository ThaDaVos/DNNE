...
namespace DNNE.Source.Generators.C99;

internal class NativeExtensionsGenerator : AbstractCodeGenerator
{
    public NativeExtensionsGenerator(AssemblyInformation assemblyInformation, INamingHelper namingHelper) : base(assemblyInformation, namingHelper)
    {
    }
